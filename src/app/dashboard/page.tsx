...
ChartJS.register(LineElement, CategoryScale, LinearScale, PointElement, Filler, Title, Tooltip);
    ...
    plugins: {
      ...
      annotation: {
        annotations: {
          highlight: {
            type: "box",
            xMin: 6, // Adjust to match the point on the x-axis
            xMax: 6,
            yMin: 0,
            yMax: 9000,
    ...
    datasets: [
      {
        ...
        borderColor: 'rgba(13, 86, 36, 1)', // Forest Green
        borderWidth: 2,
        fill: true,
      ...
      },
      {
        ...
        borderColor: 'rgba(100, 132, 11, 1)', // Yellow Green
        borderWidth: 2,
        fill: true,
        pointRadius: 0, // Remove points
        pointHoverRadius: 0, // Remove hover points
