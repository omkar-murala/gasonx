...
<div className="min-h-screen flex items-center justify-center bg-[#ffffff]">
   ...
   <div className="absolute top-4 left-4 flex items-center gap-2 z-20">
          <Image
            src="https://xp99dtac6k.ufs.sh/f/9senG9WLDt3PJ4202FtdRbC34EDnUMsP0zqHcZyvj8XNl5rw" // Replace with your logo path
            width={40}
            height={40}
            alt="Gasonx Logo"
          />
          <h2 className="text-2xl font-bold">
            ...
            <span className="text-green-500">ASONX</span>
          </h2>
        </div>
<div className="relative w-[450px] h-[550px] bg-[#5F8F80]/75 rounded-lg p-8 shadow-lg translate-x-[450px] z-10">
  ...
  <div className="flex flex-col gap-4 mt-11 py-8">
    {/* Username Input */}
    <div>
